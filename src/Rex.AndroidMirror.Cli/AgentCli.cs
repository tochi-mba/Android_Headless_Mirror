...
public sealed record AgentCommandResult(int ExitCode, string Json);
...
public static class AgentCli
{
    ...
    private static async Task<AgentCommandResult> DeviceAsync(
        string[] args,
        IBridgeClient bridge)
    {
    ...
    private static async Task<AgentCommandResult> AndroidAsync(
        string[] args,
        IBridgeClient bridge)
    {
    ...
    private static AgentCommandResult Config(string[] args, ConfigStore config)
    {
    ...
    private static async Task<AgentCommandResult> RunScriptAsync(
        string command,
        IProcessRunner runner,
        string script,
    ...
    private static AgentCommandResult ProcessFailure(
        string command,
    ...
    private static AgentCommandResult Success(string command, object data) =>
        Build(0, new
        {
            ok = true,
            protocolVersion = ProtocolVersion,
    ...
    private static AgentCommandResult Failure(
        Exception ex,
        string? command = null,
        int exitCode = 1) =>
        Build(exitCode, new
    ...
    private static AgentCommandResult Build(int exitCode, object payload) =>
